...
<body>
  ...
  <div id="frame" class="outline">
    ...
    <?php if ( 1 == $app->getCfg( 'display_offline_message', 1 ) && '' != str_replace( ' ', '', $app->getCfg( 'offline_message') )): ?>
		<p><?php echo $app->getCfg( 'offline_message' ); ?></p>
    <?php elseif ( 2 == $app->getCfg( 'display_offline_message', 1 ) && '' != str_replace( ' ', '', JText::_( 'JOFFLINE_MESSAGE' ) ) ): ?>
